...
/* harmony export (immutable) */ __webpack_exports__["getMessageType"] = getMessageType;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mvelo__ = __webpack_require__(/*! ../mvelo */ 0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__clientAPI__ = __webpack_require__(/*! ./clientAPI */ 4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providerSpecific__ = __webpack_require__(/*! ./providerSpecific */ 13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__decryptFrame__ = __webpack_require__(/*! ./decryptFrame */ 14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__verifyFrame__ = __webpack_require__(/*! ./verifyFrame */ 15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__importFrame__ = __webpack_require__(/*! ./importFrame */ 16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__encryptFrame__ = __webpack_require__(/*! ./encryptFrame */ 17);
/**
...
const NAME = `mainCS-${__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.util.getHash()}`;
...
document.body.dataset.mailvelopeVersion = '2.2.2';

function connect() {
  if (document.mveloControl) {
    return;
  }
  port = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.connect({name: NAME});
  addMessageListener();
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()(document).ready(connect);
...
function init(preferences, watchlist) {
  ...
  if (clientApiActive) {
    // api case
    __WEBPACK_IMPORTED_MODULE_2__clientAPI__["a" /* init */]();
    return;
  }

  // non-api case ... use provider specific content scripts
  __WEBPACK_IMPORTED_MODULE_3__providerSpecific__["b" /* init */]();
  currentProvider = __WEBPACK_IMPORTED_MODULE_3__providerSpecific__["a" /* get */](host);
  // turn on scan loop
  on();
}
...
function detectHost() {
  clientApiActive = watchList.some(site => site.active && site.frames && site.frames.some(frame => {
    const hostRegex = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.util.matchPattern2RegEx(frame.frame);
...
function findPGPTag() {
  ...
  nodeList = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(nodeList).filter(function() {
    const element = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this);
...
function findEditable() {
  ...
  let editable = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('[contenteditable], textarea').filter(':visible').not('body');
  const iframes = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('iframe').filter(':visible');
  // find dynamically created iframes where src is not set
  const dynFrames = iframes.filter(function() {
    const src = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).attr('src');
  ...
  dynFrames.each(function() {
    const content = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).contents();
    ...
    .data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.DYN_IFRAME, true)
    // add iframe element
    .data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.IFRAME_OBJ, __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this));
    ...
    if (content.attr('designMode') === 'on' || content.find('body[contenteditable]').length !== 0) {
      ...
      editable = editable.add(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this));
    } else {
  ...
  const anchor = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<a/>');
  const editableBody = iframes.not(dynFrames).filter(function() {
    const frame = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this);
    ...
    if (anchor.attr('href', frame.attr('src')).prop('hostname') === document.location.hostname) {
      try {
        ...
        if (content.attr('designMode') === 'on' || content.find('body[contenteditable]').length !== 0) {
          ...
          //content.find('body').off("contextmenu").on("contextmenu", onContextMenu);
          // mark body as 'inside iframe'
          content.find('body').data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.IFRAME_OBJ, frame);
          return true;
        } else {
          return false;
        }
  ...
  editable = editable.filter(function() {
    return __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).height() > MIN_EDIT_HEIGHT;
  });
  return editable;
}
...
function getMessageType(armored) {
  if (/END\sPGP\sMESSAGE/.test(armored)) {
    return __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_MESSAGE;
  } else if (/END\sPGP\sSIGNATURE/.test(armored)) {
    return __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_SIGNATURE;
  } else if (/END\sPGP\sPUBLIC\sKEY\sBLOCK/.test(armored)) {
    return __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_PUBLIC_KEY;
  } else if (/END\sPGP\sPRIVATE\sKEY\sBLOCK/.test(armored)) {
    return __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_PRIVATE_KEY;
  }
}
...
function attachExtractFrame(element) {
  ...
  const newObj = element.filter(function() {
    return !isAttached(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).parent());
  });
  // create new decrypt frames for new discovered PGP tags
  newObj.each((index, element) => {
    try {
      // parent element of text node
      const pgpEnd = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(element).parent();
      switch (getMessageType(pgpEnd.text())) {
        case __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_MESSAGE: {
          const dFrame = new __WEBPACK_IMPORTED_MODULE_4__decryptFrame__["a" /* default */]();
          dFrame.attachTo(pgpEnd);
          break;
        }
        case __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_SIGNATURE: {
          const vFrame = new __WEBPACK_IMPORTED_MODULE_5__verifyFrame__["a" /* default */]();
          vFrame.attachTo(pgpEnd);
          break;
        }
        case __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_PUBLIC_KEY: {
          const imFrame = new __WEBPACK_IMPORTED_MODULE_6__importFrame__["a" /* default */]();
...
function attachEncryptFrame(element, expanded) {
  ...
  const newObj = element.filter(function() {
    if (expanded) {
      ...
      if (element.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_STATUS) === __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_ATTACHED) {
        // trigger expand state of attached frames
        element.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_OBJ).showEncryptDialog();
        return false;
      } else {
        return true;
      }
      ...
      return !isAttached(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this));
    }
  });
  // create new encrypt frames for new discovered editable fields
  newObj.each((index, element) => {
    const eFrame = new __WEBPACK_IMPORTED_MODULE_7__encryptFrame__["a" /* default */]();
    eFrame.attachTo(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(element), {expanded});
  });
}
...
function isAttached(element) {
  const status = element.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_STATUS);
  switch (status) {
    case __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_ATTACHED:
    case __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_DETACHED:
      return true;
    default:
      return false;
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(/*! jquery */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__main__ = __webpack_require__(/*! ./main */ 1);
/**
...
class ExtractFrame {
  constructor() {
    this.id = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.util.getHash();
    ...
    this._currentProvider = __WEBPACK_IMPORTED_MODULE_2__main__["currentProvider"];
  }
  ...
  _init(pgpEnd) {
    ...
    this._pgpEnd.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_STATUS, __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_ATTACHED);
    // store frame obj in pgpText tag
    this._pgpEnd.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_OBJ, this);
  ...
  _renderFrame() {
    this._eFrame = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div/>', {
      id: `eFrame-${this.id}`,
    ...
    if (this._pgpElement.height() > __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.LARGE_FRAME) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()(window).resize(this._setFrameDim.bind(this));
  ...
  _closeFrame(finalClose) {
    this._eFrame.fadeOut(() => {
      ...
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()(window).off('resize');
      this._eFrame.remove();
      if (finalClose === true) {
        this._port.disconnect();
        this._pgpEnd.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_STATUS, null);
      } else {
        this._pgpEnd.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_STATUS, __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_DETACHED);
      }
      this._pgpEnd.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_OBJ, null);
    });
    return false;
  }
  ...
  _establishConnection() {
    this._port = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.connect({name: this._ctrlName});
  ...
  _getPGPMessage() {
    ...
    msg = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.util.normalizeArmored(msg, this._typeRegex);
    return msg;
  }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ExtractFrame;
...
/*!******************************************!*\
  ...
  \******************************************/
/*! exports provided: init, postMessage */
/*! exports used: init, postMessage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__main__ = __webpack_require__(/*! ./main */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__decryptContainer__ = __webpack_require__(/*! ./decryptContainer */ 6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__editorContainer__ = __webpack_require__(/*! ./editorContainer */ 7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__appContainer__ = __webpack_require__(/*! ./appContainer */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__keyGenContainer__ = __webpack_require__(/*! ./keyGenContainer */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__keyBackupContainer__ = __webpack_require__(/*! ./keyBackupContainer */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__restoreBackupContainer__ = __webpack_require__(/*! ./restoreBackupContainer */ 11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__syncHandler__ = __webpack_require__(/*! ./syncHandler */ 12);
/**
...
function init() {
  ...
  if (apiTag) {
    if (apiTag.dataset.version !== __WEBPACK_IMPORTED_MODULE_2__main__["prefs"].version) {
      window.setTimeout(() => {
        window.dispatchEvent(new CustomEvent('mailvelope-disconnect', {detail: {version: __WEBPACK_IMPORTED_MODULE_2__main__["prefs"].version}}));
      }, 1);
    }
    return;
  }
  ...
  if (!window.mailvelope) {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<script/>', {
      id: 'mailvelope-api',
      src: __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.getURL('client-API/mailvelope-client-api.js'),
      'data-version': __WEBPACK_IMPORTED_MODULE_2__main__["prefs"].version
    }).appendTo(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('head'));
  }
}

function postMessage(eventName, id, data, error) {
  window.postMessage({
    event: eventName,
...
function checkTypes(data) {
  if (data.id && typeof data.id !== 'string') {
    throw new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error('Type mismatch: data.id should be of type string.', 'TYPE_MISMATCH');
  }
  if (!data.data) {
    return;
  }
...
function enforceTypeWhitelist(data, whitelist) {
  ...
  for (let i = 0; i < parameters.length; i++) {
    ...
    if (wrong) {
      throw new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error(`Type mismatch: ${parameter} should be of type ${dataType}.`, 'TYPE_MISMATCH');
    }
  }
}
...
function eventListener(event) {
  ...
  try {
    ...
    if (data && data.identifier) {
      if (data.identifier.indexOf(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.KEYRING_DELIMITER) !== -1) {
        throw {message: 'Identifier invalid.', code: 'INVALID_IDENTIFIER'};
      }
      keyringId = __WEBPACK_IMPORTED_MODULE_2__main__["host"] + __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.KEYRING_DELIMITER + data.identifier;
    }
    switch (event.data.event) {
      case 'get-version':
        reply(event.data.id, null, __WEBPACK_IMPORTED_MODULE_2__main__["prefs"].version);
        break;
      case 'get-keyring':
...
function getKeyring(keyringId, callback) {
  __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.sendMessage({
    event: 'get-keyring',
    api_event: true,
    keyringId
  }, result => {
...
function displayContainer(selector, armored, keyringId, options, callback) {
  let container;
  switch (Object(__WEBPACK_IMPORTED_MODULE_2__main__["getMessageType"])(armored)) {
    case __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_MESSAGE:
      container = new __WEBPACK_IMPORTED_MODULE_3__decryptContainer__["a" /* default */](selector, keyringId, options);
      break;
    case __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_SIGNATURE:
      throw new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error('PGP signatures not supported.', 'WRONG_ARMORED_TYPE');
    case __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_PUBLIC_KEY:
      throw new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error('PGP keys not supported.', 'WRONG_ARMORED_TYPE');
    default:
      throw new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error('No valid armored block found.', 'WRONG_ARMORED_TYPE');
  }
...
function editorContainer(selector, keyringId, options = {}, callback) {
  ...
  const container = new __WEBPACK_IMPORTED_MODULE_4__editorContainer__["a" /* default */](selector, keyringId, options);
...
function settingsContainer(selector, keyringId, options = {}, callback) {
  __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.sendMessage({
    ...
    const container = new __WEBPACK_IMPORTED_MODULE_5__appContainer__["a" /* default */](selector, keyringId, options);
    containers.set(container.id, container);
    container.create(callback);
  });
}
...
function keyGenContainer(selector, keyringId, options = {}, callback) {
  ...
  const container = new __WEBPACK_IMPORTED_MODULE_6__keyGenContainer__["a" /* default */](selector, keyringId, options);
  containers.set(container.id, container);
  container.create(callback);
}

function keyBackupContainer(selector, keyringId, options = {}, callback) {
  const container = new __WEBPACK_IMPORTED_MODULE_7__keyBackupContainer__["a" /* default */](selector, keyringId, options);
  containers.set(container.id, container);
  container.create(callback);
}

function restoreBackupContainer(selector, keyringId, options = {}, callback) {
  const container = new __WEBPACK_IMPORTED_MODULE_8__restoreBackupContainer__["a" /* default */](selector, keyringId, options);
  containers.set(container.id, container);
  container.create(callback);
}
...
function importPublicKey(keyringId, armored, callback) {
  switch (Object(__WEBPACK_IMPORTED_MODULE_2__main__["getMessageType"])(armored)) {
    case __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_PUBLIC_KEY:
      // ok
      break;
    case __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_PRIVATE_KEY:
      throw new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error('No import of private PGP keys allowed.', 'WRONG_ARMORED_TYPE');
    default:
      throw new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error('No valid armored block found.', 'WRONG_ARMORED_TYPE');
  }
  __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.sendMessage({
...
function setLogo(keyringId, dataURL, revision, callback) {
  if (!/^data:image\/png;base64,/.test(dataURL)) {
    throw new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error('Data URL must start with "data:image/png;base64,".', 'LOGO_INVALID');
  }
  if (dataURL.length > 15 * 1024) {
    throw new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error('Data URL string size exceeds 15KB limit.', 'LOGO_INVALID');
  }
  __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.sendMessage({
    event: 'set-logo',
    api_event: true,
...
function addSyncHandler(keyringId, callback) {
  syncHandler = syncHandler || new __WEBPACK_IMPORTED_MODULE_9__syncHandler__["a" /* default */](keyringId);
...
class DecryptContainer {
  constructor(selector, keyringId, options) {
    ...
    this.port = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.connect({name: this.name});
  ...
  create(armored, done) {
    ...
    const url = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.getURL(`components/decrypt-message/decryptMessage.html?id=${this.id}&isContainer=true`);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = DecryptContainer;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mvelo__ = __webpack_require__(/*! ../mvelo */ 0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mvelo___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__mvelo__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__main__ = __webpack_require__(/*! ./main */ 1);
/**
 * Copyright (C) 2014-2016 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
class EditorContainer {
  ...
  create(done) {
    ...
    const url = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.getURL(`components/editor/editor.html?id=${this.id}${quota}&embedded=true`);
    this.container.setAttribute('src', url);
    this.container.setAttribute('frameBorder', 0);
    this.container.setAttribute('scrolling', 'no');
    this.container.style.width = '100%';
  ...
  checkInProgress() {
    if (this.encryptCallback || this.createDraftCallback) {
      throw new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error('Encyption already in progress.', 'ENCRYPT_IN_PROGRESS');
    }
  }

  processOptions() {
    if (this.options.quotedMail && Object(__WEBPACK_IMPORTED_MODULE_1__main__["getMessageType"])(this.options.quotedMail) !== __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_MESSAGE ||
        this.options.armoredDraft && Object(__WEBPACK_IMPORTED_MODULE_1__main__["getMessageType"])(this.options.armoredDraft) !== __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PGP_MESSAGE) {
      return new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error('quotedMail or armoredDraft parameter need to be a PGP message.', 'WRONG_ARMOR_TYPE');
    }
    if (this.options.armoredDraft && (this.options.predefinedText || this.options.quotedMail ||
      ...
      return new __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.Error('armoredDraft parameter cannot be combined with parameters: predefinedText, quotedMail, quotedMailIndent, quotedMailHeader.', 'INVALID_OPTIONS');
    }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = EditorContainer;
...
class AppContainer {
  ...
  create(done) {
    ...
    const url = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.getURL(`app/app.html?${options}`);
    this.container.setAttribute('src', url);
    this.container.setAttribute('frameBorder', 0);
...
class KeyGenContainer {
  ...
  create(done) {
    ...
    this.parent = document.querySelector(this.selector);
    this.container = document.createElement('iframe');
    const url = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.getURL(`components/generate-key/keyGenDialog.html?id=${this.id}`);
    this.container.setAttribute('src', url);
    this.container.setAttribute('frameBorder', 0);
    this.container.setAttribute('scrolling', 'no');
    this.container.style.width = '100%';
...
/* harmony export (immutable) */ __webpack_exports__["a"] = KeyGenContainer;
...
class KeyBackupContainer {
  ...
  constructor(selector, keyringId, options) {
    ...
    this.done = null;
    this.popupDone = null;
    this.host = __WEBPACK_IMPORTED_MODULE_1__main__["host"];
  }
   ...
   */
  create(done) {
    const url = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.getURL(`components/key-backup/keyBackupDialog.html?id=${this.id}`);
    ...
    this.port.postMessage({
      ...
      sender: this.name,
      host: __WEBPACK_IMPORTED_MODULE_1__main__["host"],
      keyringId: this.keyringId,
...
/* harmony export (immutable) */ __webpack_exports__["a"] = KeyBackupContainer;
...
class RestoreBackupContainer {
   ...
   */
  create(done) {
    const url = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.getURL(`components/restore-backup/restoreBackupDialog.html?id=${this.id}`);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = RestoreBackupContainer;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mvelo__ = __webpack_require__(/*! ../mvelo */ 0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mvelo___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__mvelo__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__clientAPI__ = __webpack_require__(/*! ./clientAPI */ 4);
/**
 * Copyright (C) 2015-2016 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
class SyncHandler {
  ...
  registerEventListener() {
    this.port.onMessage.addListener(msg => {
      switch (msg.event) {
        case 'sync-event':
          Object(__WEBPACK_IMPORTED_MODULE_1__clientAPI__["b" /* postMessage */])('sync-event', null, msg, null);
          break;
        default:
          console.log('unknown event', msg);
      }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SyncHandler;
...
class Gmail {
   ...
   */
  getRecipients() {
    return Promise.resolve(dom.getAttr(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.oL.aDm span[email], .vR span[email]'), 'email'));
  }
  ...
  setRecipients({recipients = []}) {
    ...
    const displayArea = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.aoD.hl'); // email display only area
    const tagRemove = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.fX .vR .vM'); // email tags remove button
    const input = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.fX .vO'); // the actual recipient email address text input (a textarea)
    const subject = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.aoT'); // subject field
    const editor = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.aO7 .Am'); // editor
    input.val('');
...
class Yahoo {
   ...
   */
  getRecipients() {
    return Promise.resolve(dom.getAttr(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.compose-header span[data-address]'), 'data-address'));
  }
  ...
  setRecipients({recipients = []}) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.compose-header li.hLozenge').remove();
    // enter address text into input
    const text = joinEmail(recipients);
    const input = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.compose-header #to .recipient-input input');
    input.val(text);
    // trigger change event by switching focus
    dom.setFocus(input)
    .then(() => {
      // set focus to subject field, or to compose area in the reply case
      dom.setFocus(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#subject-field').is(':visible') ? __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#subject-field') : __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.compose-message .cm-rtetext'));
    });
  }
...
class Outlook {
  getRecipients(editElement) {
    ...
    return __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.util.sequential(this.extractPersona.bind(this), personas);
  }
      ...
      const observer = new MutationObserver(mutations => {
        mutations.forEach(mutation => {
          ...
          const searchInterval = setInterval(() => {
            ...
            if (personaCard.length && __WEBPACK_IMPORTED_MODULE_1_jquery___default()(personaCard).text().match(HAS_EMAIL)) {
  ...
  extractPersona(pane) {
    ...
    return this.waitForPersonaCard(() => __WEBPACK_IMPORTED_MODULE_1_jquery___default()(pane).click())
    .then(({personaCard, addedNode}) => {
      // hide persona popup
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()(addedNode).hide();
      return dom.getText(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(personaCard).find('span'));
    })
    .catch(() => []);
  }
...
function parseEmail(elements, extract) {
  ...
  elements.each(function() {
    const value = extract(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__main__ = __webpack_require__(/*! ./main */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__extractFrame__ = __webpack_require__(/*! ./extractFrame */ 3);
/**
 * Copyright (C) 2012-2016 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
class DecryptFrame extends __WEBPACK_IMPORTED_MODULE_3__extractFrame__["a" /* default */] {
  constructor() {
    super();
    this._dDialog = null;
  ...
  _clickHandler() {
    super._clickHandler();
    if (__WEBPACK_IMPORTED_MODULE_2__main__["prefs"].security.display_decrypted == __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.DISPLAY_INLINE) {
      this._inlineDialog();
    } else if (__WEBPACK_IMPORTED_MODULE_2__main__["prefs"].security.display_decrypted == __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.DISPLAY_POPUP) {
      this._popupDialog();
    }
    return false;
  }
  ...
  _inlineDialog() {
    this._dDialog = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<iframe/>', {
      id: `dDialog-${this.id}`,
      'class': 'm-frame-dialog',
      frameBorder: 0,
      scrolling: 'no'
    });
    const url = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.getURL(`components/decrypt-message/decryptMessage.html?id=${this.id}`);
      ...
      switch (msg.event) {
        ...
        case 'get-armored':
          ...
          .then(sender => {
            ...
            sender = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.util.deDup(sender);
            this._port.postMessage({
              event: 'set-armored',
...
/* harmony export (immutable) */ __webpack_exports__["a"] = DecryptFrame;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(/*! jquery */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__extractFrame__ = __webpack_require__(/*! ./extractFrame */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__main__ = __webpack_require__(/*! ./main */ 1);
/**
 * Copyright (C) 2015-2016 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
class VerifyFrame extends __WEBPACK_IMPORTED_MODULE_2__extractFrame__["a" /* default */] {
  constructor() {
    super();
    this._vDialog = null;
    // verify popup active
  ...
  _clickHandler() {
    super._clickHandler();
    if (__WEBPACK_IMPORTED_MODULE_3__main__["prefs"].security.display_decrypted == __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.DISPLAY_INLINE) {
      this._inlineDialog();
    } else if (__WEBPACK_IMPORTED_MODULE_3__main__["prefs"].security.display_decrypted == __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.DISPLAY_POPUP) {
      this._popupDialog();
    }
    return false;
  }
  ...
  _inlineDialog() {
    this._vDialog = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<iframe/>', {
      id: `vDialog-${this.id}`,
      'class': 'm-frame-dialog',
      frameBorder: 0,
      scrolling: 'no'
    });
    const url = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.getURL(`components/verify-inline/verifyInline.html?id=${this.id}`);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = VerifyFrame;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__extractFrame__ = __webpack_require__(/*! ./extractFrame */ 3);
/**
 * Copyright (C) 2013-2016 Mailvelope GmbH
 * Licensed under the GNU Affero General Public License version 3
 */
...
class ImportFrame extends __WEBPACK_IMPORTED_MODULE_0__extractFrame__["a" /* default */] {
  constructor() {
    super();
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ImportFrame;
...
class EncryptFrame extends __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.EventHandler {
  constructor() {
    super();
    this.id = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.util.getHash();
    ...
    this._editorType = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PLAIN_TEXT; //prefs.general.editor_type;
  ...
  attachTo(element, options) {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.extend(this._options, options);
    this._init(element);
    this._establishConnection();
    this._registerEventListener();
    this._renderFrame();
    // set status to attached
    this._editElement.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_STATUS, __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_ATTACHED);
    // store frame obj in element tag
    this._editElement.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_OBJ, this);
  }
  ...
  _init(element) {
    ...
    if (!this._editElement.is('body') && this._editElement.closest('body').data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.DYN_IFRAME)) {
      const html = this._editElement.closest('html');
      if (!html.data('M-STYLE')) {
        const style = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<link/>', {
          rel: 'stylesheet',
          href: __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.getURL('content-scripts/framestyles.css')
        });
        // add style
  ...
  _establishConnection() {
    this._port = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.runtime.connect({name: `eFrame-${this.id}`});
  ...
  _renderFrame() {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()(window).on('resize', this._setFrameDim.bind(this));
  ...
  _closeFrame(finalClose) {
    this._eFrame.fadeOut(() => {
      ...
      if (finalClose === true) {
        this._port.disconnect();
        this._editElement.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_STATUS, null);
      } else {
        this._editElement.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_STATUS, __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_DETACHED);
      }
      this._editElement.data(__WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.FRAME_OBJ, null);
    });
    return false;
  }
  ...
  _showMailEditor() {
    const options = {};
    const emailContent = this._getEmailText(this._editorType == __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.PLAIN_TEXT ? 'text' : 'html');
    if (/BEGIN\sPGP\sMESSAGE/.test(emailContent)) {
      try {
        options.quotedMail = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.util.normalizeArmored(emailContent, /-----BEGIN PGP MESSAGE-----[\s\S]+?-----END PGP MESSAGE-----/);
      } catch (e) {
  ...
  _html2text(html) {
    html = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div/>').html(html);
    // replace anchors
    html = html.find('a').replaceWith(function() {
      return `${__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).text()} (${__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).attr('href')})`;
    })
    .end()
    .html();
    ...
    html = html.replace(/<(.+?)>/g, ''); // remove tags
    html = html.replace(/\n{3,}/g, '\n\n'); // compress new line
    return __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div/>').html(html).text(); // decode
  }
  ...
  _setMessage(msg, type) {
    if (this._emailTextElement.is('textarea')) {
      ...
      msg = __WEBPACK_IMPORTED_MODULE_0__mvelo___default.a.util.decodeHTML(msg);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = EncryptFrame;
