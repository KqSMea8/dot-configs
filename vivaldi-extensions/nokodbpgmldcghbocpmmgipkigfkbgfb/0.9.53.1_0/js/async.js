...
µBlock.updateContextAsync = (function() {
    ...
    var updateContext = function(tabId) {
        delete tabIdToTimer[tabId];
			//console.log("Updating asyn cntext");
		extension.intentlyContextMenus.updateContext(tabId)
    ...
    return function(tabId) {
        ...
        tabIdToTimer[tabId] = setTimeout(updateContext.bind(null, tabId), 500);
    };
})();
