...
define(['underscore', '/util/etask.js', '/bext/pub/browser.js',
    '/util/zerr.js', '/bext/pub/util.js', '/util/storage.js'],
...
function get_perr_browser(){
    ...
    var browser = bg_main && bg_main.get('browser');
    if (browser=='chrome' && !zconf.CONFIG_LOCAL_CCGI_CHROME)
        browser = 'hola_browser';
    return browser;
}
/* XXX arik: mv to be_util so we can reuse code with lib.js */
