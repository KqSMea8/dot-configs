...
E.init = function(){
    E.agents = {};
    E.agent_types = {};
    // refresh agents list when premium status changes, it will load another
    // type of agents
    E.listenTo(be_ext, 'change:is_premium', function(){
        E.resolve_agents(E.agents); });
    schedule_refresh();
};
...
// 'proxy string' has the format xx[.peer]. Example: {us.peer: true, ua: true}.
