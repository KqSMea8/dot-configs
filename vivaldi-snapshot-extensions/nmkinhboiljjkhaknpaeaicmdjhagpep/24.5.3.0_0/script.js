...
//                      Fixed "Send Message" to Page button if "full screen chat" option is turned on, fixed hiding new games crap in right column, added numerals to the font selector preview popup text, removed old trending related code, added option to hide Business Discovery left column link, added hide "Create" button in top nav bar option
...
*/
  function fbpsharer() { 
	...
	var fbpsharemsg="Want more control over what you see on Facebook? F.B. Purity is a safe, free and top rated browser add-on that lets you clean up the junk on Facebook and customize it to make it just the way you like it. F.B. Purity has over 438,000 users worldwide and has been reviewed and highly recommended by The Washington Post, The New York Times, CNET, PCWorld, MacWorld and many other top tech journals. Get F.B. Purity free via FBPURITY .COM or the F.B. Purity Fan Page on Facebook";
