  ...
  function cleartheshizzle(thenode) {
	...
	*/
    ...
    if (!storynodes[0]){
      ...
      else if ((typeof(thenode.classList)!=="undefined") && thenode.classList.value.match(/_6rsm _797s/)){
	...
	/*
	var superhidematch=storynodes[i].textContent.match(/\(sponsor\)|strictly come dancing|birthday fundraiser|facebook fundraisers|bolsanaro|bolsonaro|snapchat|Thought Catalog.*(pisces|zodiac|aquarius|libra|leo|taurus|virgo|gemini|sagitarius|sagittarius|cancer)|· Paid ·|People You May Know|The Facebook Help Team|timeout\.com.*cocktails/i);
...
*/
  function fbpsharer() { 
	...
	var fbpsharemsg="Want more control over what you see on Facebook? F.B. Purity is a safe, free and top rated browser add-on that lets you clean up the junk on Facebook and customize it to make it just the way you like it. F.B. Purity has over 446,000 users worldwide and has been reviewed and highly recommended by The Washington Post, The New York Times, CNET, PCWorld, MacWorld and many other top tech journals. Get F.B. Purity free via FBPURITY .COM or the F.B. Purity Fan Page on Facebook";
