...
// (C) Stephen Fernandez 2009-2019   https://www.fbpurity.com
...
['Marketplace','lcmarketplace','Hides the Marketplace link in the left column, and also the &quot;Recently Viewed in Marketplace&quot;, &quot;Still available on Marketplace&quot; and &quot;Top Picks on Marketplace&quot; boxes in the right hand column.'],
...
['Payments Section','lcpayments','Hide all links under the Payments Heading (including Send or Request Money)'],
['Photos','lcphotos',''],
...
'<tr title="Show the &quot;Set as Background&quot; button under photos, which lets you set a background image for the Facebook website"><td><label class="fbpoptslabel" for="showsetasbackgbutt">Show &quot;Set as Background&quot; button</label></td><td><input id="showsetasbackgbutt" type="checkbox"></td></tr>' +
'<tr style="background-color:#ECEFF5 !important" title="Hide the coloured background selection boxes in the status update box on Newsfeed and Timeline"><td><label class="fbpoptslabel" for="colouredbackgsquares">Hide colored boxes in status update box</label></td><td><input id="colouredbackgsquares" type="checkbox"></td></tr>' +
'<tr title="Return Coloured Status (&amp; Big Font Status) Updates to normal (no background colour, no background picture, normal font, normal alignment, normal height)"><td><label class="fbpoptslabel" for="colouredbg">Normalize Colored / Big Font Statuses</label></td><td><input id="colouredbg" type="checkbox"></td></tr>' +
'<tr style="background-color:#ECEFF5 !important"  title="Return round profile images to square, and also rounded comment boxes to rectangular"><td><label class="fbpoptslabel" for="squareprofilepics">Bring back square profile pics</label></td><td><input id="squareprofilepics" type="checkbox"></td></tr>'+
'<tr  title="Remove bubble design on comments"><td><label class="fbpoptslabel" for="commentbubbles">Remove comment bubble design</label></td><td><input id="commentbubbles" type="checkbox"></td></tr>'+
'<tr style="background-color:#ECEFF5 !important" title="Hide the animations that are shown when certain words/phrases are typed in posts or comments such as congrats, rad,best wishes,xoxo,you got this,bff"><td><label class="fbpoptslabel" for="textanimations">Hide Text Animations</label></td><td><input id="textanimations" type="checkbox"></td></tr>'+
...
'<tr><td></td><td><b></b></td></tr><tr title="Hides the Home link in the top navigation bar"><td><label for="homelink" class="fbpoptslabel">Hide &quot;Home&quot; Button</label></td><td><input id="homelink" type="checkbox"></td></tr>' +
'<tr><td></td><td><b></b></td></tr><tr style="background-color:#ECEFF5 !important" title="Hides the counter next to the Home link in the top navigation bar"><td><label for="homelinkcounter" class="fbpoptslabel">Hide &quot;Home&quot; Button Count</label></td><td><input id="homelinkcounter" type="checkbox"></td></tr>' +
'<tr><td></td><td><b></b></td></tr><tr title="Hides the Quick Help (Question Mark) icon in the top navigation bar"><td><label for="hidepadlock" class="fbpoptslabel">Hide Quick Help Button</label></td><td><input id="hidepadlock" type="checkbox"></td></tr>' +
...
'<tr><td></td><td><b></b></td></tr><tr title="Clicking the bell notifications icon in the top navigation bar will open the notifications sorted in the correct chronological order"><td><label style="color:black;font-weight:normal" for="chrononotifications">Sort Notifications Chronologically</label></td><td><input id="chrononotifications" type="checkbox"></td></tr>' +
...
// changed profile pic
  ...
  if(fbpoptsobj.changedprofilepic==1)
    headerTextFilter += ",changed (h..|their) profile picture,updated (h..|their) profile picture,updated (h..|their) profile video,updated (h..|their) (360 )?cover photo,added a temporary profile picture";
...
// Shared a memory
  ...
  if (fbpoptsobj.sharedmemory ==1) {
    ...
    extraTextFilter+= ",Friends on Facebook with .* for \\d+ Year,TodaySee Your Memories,Facebook!See your memories,Year in ReviewA video looking back,Years? of Friendship on Facebook,Your year on FacebookA look back";
  }
...
//  Your memories
  ...
  if (fbpoptsobj.yourmemories ==1)
	extraTextFilter+= ",Your Facebook memories,Your Memories on Facebook,Years? of Friendship on Facebook,Celebrate Your Friendship With,We made you this video to celebrate your friendship,see more memories,A Look Back at Your Summer,we made you a video to look back on,your year in review,Your year on FacebookA look back";
...
// People You May Know
  if(fbpoptsobj.pymk==1) {
    headerTextFilter += ",People You May Know,Friend Requests,suggested people to follow";
...
// hide sponsored posts in newsfeed
  if(fbpoptsobj.sponsoredbox==1) {
    ...
    extraTextFilter += ",Recently Released Albums,Get Offer ·,Pages You May Like,Links you may like,Page Stories you may like,Jobs Near You,^Recommended for you,^Suggested because it's popular on Facebook,Advertiser-sponsored poll,suggested shows,Get (every )?New episode(s)? in your watchlist,· Paid ·,Paid partnership ·";//SponSsored
	headerTextFilter += ", claimed an offer from, posted an offer,shared a product\.,shared their product\.,posted a job\.";
...
// top nav background image
  ...
  if((fbpoptsobj.reactionsimagepackfix==1) && (typeof(fbpoptsobj.reactionsimagepack)!="undefined") && fbpoptsobj.reactionsimagepack!='') {
	if(!fbpoptsobj.reactionsimagepack.match(/\,/)){
      ...
      fbpfreestyle.textContent +=' ' + reactprefixsmall + ' { background-image: url(' + fbpoptsobj.reactionsimagepack + ') !important;background-size:99% !important} i._2p78._3j7l, i.img.sx_72c12d { background-position: 0 -47px !important} i._2p78._3j7q,i.img.sx_52e699{ background-position: 0 0 !important} i._2p78._3j7o,i.img.sx_c3c538{ background-position: 0 -31px !important} i._2p78._3j7r,i.img.sx_aef885{ background-position: 0 -79px !important} i._2p78._3j7m,i.img.sx_2c6fed{ background-position: 0 -63px !important} i._2p78._3j7n,i.img.sx_19d7b0{ background-position: 0 -94px !important}';
	  // large (medium) sizes
	  ...
	  fbpfreestyle.textContent +=' i._9-y._3j7l,i._19kl._3j7l,i._2p78._2p7a._9--.img.sx_72c12d {background-image: url(' + fbpoptsobj.reactionsimagepack + ') !important; background-size: 99% !important; height:16px;width:16px}';
	  // fix for love icon on comments
	  fbpfreestyle.textContent +=' i._9-y._3j7m,i._19kl._3j7m,i._2p78._2p7a._9--.img.sx_2c6fed {background-image: url(' + fbpoptsobj.reactionsimagepack + ') !important; background-size: 99% !important; height:16px;width:16px}';
	  // fix for haha icon on comments
	  fbpfreestyle.textContent +=' i._9-y._3j7o,i._19kl._3j7o,i._2p78._2p7a._9--.img.sx_c3c538 {background-image: url(' + fbpoptsobj.reactionsimagepack + ') !important; background-size: 99% !important; height:16px;width:16px}';
	  // fix for wow icon on comments
	  fbpfreestyle.textContent +=' i._9-y._3j7n,i._19kl._3j7n,i._2p78._2p7a._9--.img.sx_19d7b0 {background-image: url(' + fbpoptsobj.reactionsimagepack + ') !important; background-size: 99% !important; height:16px;width:16px}';
	  // fix for sad icon on comments
	  fbpfreestyle.textContent +=' i._9-y._3j7r,i._19kl._3j7r,i._2p78._2p7a._9--.img.sx_aef885 {background-image: url(' + fbpoptsobj.reactionsimagepack + ') !important; background-size: 99% !important; height:16px;width:16px}';
	  // fix for angry icon on comments
	  fbpfreestyle.textContent +=' i._9-y._3j7q,i._19kl._3j7q,i._2p78._2p7a._9--.img.sx_52e699 {background-image: url(' + fbpoptsobj.reactionsimagepack + ') !important; background-size: 99% !important; height:16px;width:16px}';
      ...
      // fix for like icon on comments	 
	  fbpfreestyle.textContent +=' i._9-y._3j7l,i._19kl._3j7l,i._2p78._2p7a._9--.img.sx_72c12d {background-image: url(' + reactimagearr[0] + ') !important; background-size: 99% !important; height:16px;width:16px;background-position:0 0 !important}'; 
	  // fix for love icon on comments
	  fbpfreestyle.textContent +=' i._9-y._3j7m,i._19kl._3j7m,i._2p78._2p7a._9--.img.sx_2c6fed {background-image: url(' + reactimagearr[1] + ') !important; background-size: 99% !important; height:16px;width:16px;background-position:0 0 !important}'; 
	  // fix for haha icon on comments
	  fbpfreestyle.textContent +=' i._9-y._3j7o,i._19kl._3j7o,i._2p78._2p7a._9--.img.sx_c3c538 {background-image: url(' + reactimagearr[2] + ') !important; background-size: 99% !important; height:16px;width:16px;background-position:0 0 !important}'; 
	  // fix for wow icon on comments
	  fbpfreestyle.textContent +=' i._9-y._3j7n,i._19kl._3j7n,i._2p78._2p7a._9--.img.sx_19d7b0 {background-image: url(' + reactimagearr[3] + ') !important; background-size: 99% !important; height:16px;width:16px;background-position:0 0 !important}'; 
	  // fix for sad icon on comments
	  fbpfreestyle.textContent +=' i._9-y._3j7r,i._19kl._3j7r,i._2p78._2p7a._9--.img.sx_aef885 {background-image: url(' + reactimagearr[4] + ') !important; background-size: 99% !important; height:16px;width:16px;background-position:0 0 !important}'; 
	  // fix for angry icon on comments
	  fbpfreestyle.textContent +=' i._9-y._3j7q,i._19kl._3j7q,i._2p78._2p7a._9--.img.sx_52e699 {background-image: url(' + reactimagearr[5] + ') !important; background-size: 99% !important; height:16px;width:16px;background-position:0 0 !important}'; 
  ...
  for(var b=0;b<lcoptsarr.length;b++)
	...
	if(fbpoptsobj.colouredbg==1) // neutralise coloured status updates
	  ...
	  // hide the big icons in the big status updates, so small ones behind show
	  ' div._5qxm._5qxn._620g span._6qdm { background: none !important } '+
	  // new code for people with new fb code
	  ' div._6rsm { min-height: auto !important; } div._6rsn { display: none !important } div._6rsp { display: none !important } div._6rsw, a._796a { background-color: inherit !important; color: black !important; font-weight: normal !important; font-size:inherit !important; margin-left:10px !important;text-align: inherit !important; padding: 15px 0px !important} div._6rsn > div._6rsp { background-size: auto !important; background-image: none !important; display: none !important; height: auto !important; }';
...
//	  fbpfreestyle.textContent += ' '; // removed because code is different for each user
    ...
    */
    ...
    if(fbpoptsobj.lcpayments==1)
      fbpfreestyle.textContent +=' #paymentsNav, #navItem_969105076459966, #navItem_1713727008865937 {display:none !important}'; 
    ...
    */
    ...
    if(fbpoptsobj.rcstories==1) {
      fbpfreestyle.textContent +=' #fb_stories_card_root,#stories_pagelet_rhc, #pagelet_composer li._1pek._vli, #timeline_composer_container li._1pek._vli, #timeline_composer_container ._1pek:nth-child(2), #pagelet_timeline_composer ._1pek:nth-child(2),  #PageComposerPagelet_ ._1pek:nth-child(2), #feedx_sprouts_container ._1pek:nth-child(2){display:none !important}'; //li[data-destination="STORIES"]
    }
...
if(photosubjectfilterlist.length) {
  ...
  */
  ...
  if (fbpoptsobj.bubblechat) {
	...
	fbpboxstyles +=' div#ChatTabsPagelet *, div[aria-label="Messages"] ._3xn5 ._3xn1, div#ChatTabsPagelet div._1aa6:after {border-radius: 0% !important} div#ChatTabsPagelet div._5wd4 {padding-top:0px !important} div#ChatTabsPagelet div._5wd4 {padding-bottom:0px !important}';
  ...
  */
  ...
  if((typeof fbpoptsobj.commentbubbles !=='undefined') && fbpoptsobj.commentbubbles) {
	fbpboxstyles += ' span.UFICommentActorAndBody {background-color:inherit !important} ._3-a6 ._10la ._10lo {background-color:inherit !important; border-radius:0 !important;box-shadow:none !important; !important } ._3-a6._1blz ._2lhm,._3-a6 ._pb2 ._2r3x, div.UFIInputContainer, div.UFICommentContent a[rel="theater"], div.UFICommentContent img.img, div.UFICommentContent div[id^=gif_comment_attachment] div,form,div[data-testid="UFI2Comment/body"],div._6a15,div._3ekx, div._2tx5 {border-radius:0!important}';
  }
          ...
          if((tempnode.nodeName=='LI') ||  (tempnode.nodeName=='UL')) {
	        ...
	        if(tempnode.classList.contains('middle_area_content')){
		      ...
		      window.setTimeout(function(x) {
				...
				if(x.querySelector('h3') && x.querySelector('h3').textContent.match(/URL Blocked|Can\'t Download|has blocked link|can't share this link/i)){
					//console.log('part 2');
  ...
  function dspBlockLink(node, blockmode) {
    ...
    if (typeof(blockmode)=='undefined') {
	  ...
	  if(node.querySelector("a[href^='https://www.facebook.com/apps/application.php?']")) {
		...
		footernode=null;
		appid=document.querySelector('a[ajaxify^="/games/quicksilver/spotlight/?app_id="]').getAttribute('ajaxify').match(/app_id=(\d+)/)[1]
		if(node.textContent.match('Click to play(.*)Play Game'))
		  appname=node.textContent.match('Click to play(.*)Play Game')[1];
	    else
		  appname="Unknown App";
	  }  
	  else{
  ...
  function cleartheshizzle(thenode) {
	...
	*/
    ...
    if (!storynodes[0]){
      ...
      if(thenode.getAttribute && thenode.classList.contains("_5jmm")) {
      ...
      else if ((typeof(thenode.classList)!=="undefined") && (typeof(thenode.classList.value)!=="undefined") && thenode.classList.value.match(/_6rsm _797s/)){
		...
		while(!thenode.getAttribute('data-dedupekey')) // find top level post node
	...
	/*var superhidematch=storynodes[i].textContent.match(/\(sponsor\)|strictly come dancing|birthday fundraiser|facebook fundraisers|arcade europe|bolsanaro|bolsonaro|brasil|snapchat|Thought Catalog.*(pisces|zodiac|aquarius|libra|leo|taurus|virgo|gemini|sagitarius|sagittarius|cancer)|· Paid ·|People You May Know|The Facebook Help Team|timeout\.com.*cocktails/i);
	if(typeof(superhidematch)!='undefined' && superhidematch && superhidematch.length){
	  storynodes[i].querySelector("a.hidepostlink").click();
      filtermatchmsg(storynodes[i],'FBP : Super Hide Match - ' + superhidematch[0]);
	}
	*/
	  ...
	  if(fbpoptsobj.sponsoredbox){
	    if((!storynodes[i].querySelector('abbr')) || ((storynodes[i].querySelector('abbr.livetimestamp')) && window.getComputedStyle(storynodes[i].querySelector('abbr.livetimestamp').parentNode.parentNode.parentNode).getPropertyValue('display')=='none')||(storynodes[i].textContent.match(/^Suggested /i)) || (storynodes[i].querySelector('a[ajaxify^="/feed/verified_voice_context"],a[ajaxify^="/feed/branded_content/"]'))){ //,div[data-ad-preview]
		  ...
		  insertnoadvidlink(storynodes[i]);
		}
		else{
	  ...
	  */
	  ...
	  if (storynodes[i].querySelector('a[rel="theater"][title]')) {
		...
		if (ocrImageTextMatch && ocrImageTextMatch.length)
		  ocrImageText=ocrImageTextMatch[1];
	      //console.log(ocrImageText);
	  }
...
*/
  function fbpsharer() { 
	...
	var fbpsharemsg="Want more control over what you see on Facebook? F.B. Purity is a safe, free and top rated browser add-on that lets you clean up the junk on Facebook and customize it to make it just the way you like it. F.B. Purity has over 448,000 users worldwide and has been reviewed and highly recommended by The Washington Post, The New York Times, CNET, PCWorld, MacWorld and many other top tech journals. Get F.B. Purity free via FBPURITY .COM or the F.B. Purity Fan Page on Facebook";
...
function getfriendlist() {
  ...
  var fb_dtsg_ag;
  var fb_dtsg_ag_match=document.documentElement.innerHTML.match(/\"async_get_token\"\:\"(.*?)\"/);
  if (fb_dtsg_ag_match.length)
    fb_dtsg_ag=fb_dtsg_ag_match[1].replace(/:/,'%3A');
  else {
  ...
  var FBP_FRIEND_FEED = "www.facebook.com/ajax/typeahead/first_degree.php?fb_dtsg_ag=" + fb_dtsg_ag + "&__a=1&viewer=" + userid + "&__user=" + userid + "&token=v7&filter[0]=user&options[0]=friends_only&time=" + Math.floor((new Date()).getTime() / 1000);	// &token=1-1
...
///////////////////////////
  ...
  function shazam(e){ //  not working on Page Timelines yet...
    ...
    if(e.target.parentNode.previousSibling.querySelector("abbr").parentNode.href.match(/story_fbid=/))  // /permalink.php?story_fbid=2010364992329734&id=224203727612545
      window.open("https://m.facebook.com/" + e.target.parentNode.previousSibling.querySelector("abbr").parentNode.href.match(/story_fbid=(\d+)/)[1] + "/#tempwin" );
    else{
      //console.log(e.target.parentNode.previousSibling.querySelector("abbr[data-utime]").parentNode.href);
      window.open("https://m.facebook.com/" + e.target.parentNode.previousSibling.querySelector("abbr").parentNode.href.match(/\/(\d+)\/*/)[1] + "/#tempwin" );
    }
  }
  function insertnoadvidlink(vidnode){
    ...
    noadvidlink.title='FBP: The video below contains an ad inserted by Facebook. Click this link to view the video in a new tab with no ads.';
 ...
 function toggleFullScreen(e) {
  ...
  window.setTimeout(function(){
	...
	if(document.querySelector("div._53mw[data-store]")) {
	  ...
	  document.write("<video preload autoplay controls src='" + x.src +"' width="+x.width*2+ " height=" + x.height*2 +" ></video><p><a style='margin-left:200px' href='javascript:window.close()'>Close Video and Return to Facebook</a></p>" );
	}
	  ...
	  if(document.querySelector("a[href^='/video_redirect']")){
		...
		xp.innerHTML="<a style='margin-left:200px' href='javascript:window.close()'>Close Video and Return to Facebook</a>";
    ...
    document.querySelector('video').addEventListener('click',playpausevid,false);
	...
	document.querySelector('video').addEventListener('dblclick',toggleFullScreen,false);
  },3000);
}
