...
var INTENTLY_LOGOUT_DEBUG = []; // this is for debugging logout issue
var intentlyActive = false; //begin as inactive
var intentlyInitializing = false; //keep track of initialization state
var userLoggedIn = true; //assume user is logged in
var intentlyData = {}; //object for all relevant api data
