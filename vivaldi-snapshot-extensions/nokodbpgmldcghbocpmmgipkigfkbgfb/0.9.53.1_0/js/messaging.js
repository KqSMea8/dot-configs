...
var onMessage = function(request, sender, callback) {
    var µb = µBlock;
	 ...
	 if(undefined == request  || undefined == request.what){
    ...
    switch ( request.what ) {
        case 'contextMenuEvent':
			...
			console.log("µb.contextMenuClientY",µb.contextMenuClientY)
            break;
        ...
        case 'createUserFilter':
            ...
            //µb.appendUserFilters(request.filters);
			 if ( sender && sender.tab ) {
					...
					vAPI.messaging.handleIntentlyMsg(sender.tab.id,request.intentlyResponse,function(){})	
			 }else{
