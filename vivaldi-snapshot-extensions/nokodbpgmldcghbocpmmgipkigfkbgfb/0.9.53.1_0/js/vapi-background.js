...
var INTENTLY_ICON_PATHS = {
"whitelist":{'38': 'img/browsericons/intentlyLogoWhite38.png','19': 'img/browsericons/intentlyLogoWhite19.png'},
"active":{'38': 'img/browsericons/intentlyLogoActive38.png','19': 'img/browsericons/intentlyLogoActive19.png'},
"off":{'38': 'img/browsericons/intentlyLogoRed38.png','19': 'img/browsericons/intentlyLogoRed19.png'},
"init":{'38': 'img/browsericons/intentlyLogoInit38.png','19': 'img/browsericons/intentlyLogoInit19.png'}
...
vAPI.setIntentlyIcon = function(tabId, detail) {
    ...
    var onIconReady = function() {
	 ...
	 chrome.browserAction.setIcon({ tabId: tabId, path: INTENTLY_ICON_PATHS[iconStatus] }, onIconReady);
        ...
        vAPI.tabs.injectScript(tabId, {
	     ...
	     vAPI.tabs.injectScript(tabId, {
            ...
            runAt: 'document_start'
					...
					vAPI.tabs.injectScript(tabId, {
					file: 'js/intently-conf.js',
					allFrames: true,
					runAt: 'document_start'
				},function(){
					
							vAPI.tabs.injectScript(tabId, {
								file: "js/intently-client.js",
								allFrames: true,
								runAt: 'document_start'
							}, function(){
										vAPI.tabs.injectScript(tabId, {
...
/*
    try {
        ...
        chrome.browserAction.setIcon({ path: INTENTLY_ICON_PATHS.off });
    }
    catch(e) {
