...
define(['jquery', '/bext/pub/backbone.js', 'underscore', '/util/zerr.js',
    ...
    '/util/escape.js', '/bext/pub/browser.js', '/util/user_agent.js',
    '/util/ajax.js', '/util/storage.js', '/util/array.js', '/util/util.js'],
...
E.unsupported_browser = function(){
    if (!chrome)
        return false;
    return version_util.cmp(E.browser_guess.version, '22.0.1229.79')<0;
};
...
// XXX alexeym: sync util.js <-> be.js
